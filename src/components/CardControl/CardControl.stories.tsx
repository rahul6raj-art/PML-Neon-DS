...
import { CardControl, type CardControlProps } from './CardControl';

type FlatArgs = Omit<CardControlProps, 'selection'> & {
  sel2?: number;
  sel3?: number;
  sel4?: number;
  sel5?: number;
...
/* ── 7 Dots — middle selection ───────────────────── */
export const SevenDotsMiddle: Story = {
  args: { dots: 7, sel7: 4 },
};

/* ── 7 Dots — last selection ─────────────────────── */
...
function InteractiveRender() {
  ...
  return (
    ...
    >
      ...
      <CardControl dots={dots} selection={active} onChange={setActive} />
